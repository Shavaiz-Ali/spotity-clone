    ...
    <>
      <div className="w-full flex justify-between items-center font-semibold">
        ...
        <div className="flex items-center gap-4">
          ...
          <p className="bg-black text-white text-[15px] px-3 py-1 rounded-2xl">
            Install app
          </p>
          <p className="bg-purple-500 text-black w-7 h-7 flex justify-center items-center rounded-full">
            D
          </p>
        </div>
      </div>
